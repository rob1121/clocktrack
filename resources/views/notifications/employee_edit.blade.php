                ...
                <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                ...
                                <label class="control-label">
                                    <input type="checkbox" name="tuesday" {{old('tuesday', $notif->tuesday) ? 'checked' : '' }}>
                                    Tue
                                </label>
                                <label class="control-label">
                                    <input type="checkbox" name="wednesday" {{old('wednesday', $notif->wednesday) ? 'checked' : '' }}>
                                    Wed
                                </label>
                                <label class="control-label">
                                    <input type="checkbox" name="thursday" {{old('thursday', $notif->thursday) ? 'checked' : '' }}>
                                    Thur
                                </label>
                                <label class="control-label">
                                    <input type="checkbox" name="friday" {{old('friday', $notif->friday) ? 'checked' : '' }}>
                                    Fri
                                </label>
                                <label class="control-label">
                                    <input type="checkbox" name="saturday" {{old('saturday', $notif->saturday) ? 'checked' : '' }}>
                                    Sat
                                </label>
                                <label class="control-label">
                                    <input type="checkbox" name="sunday" {{old('sunday', $notif->sunday) ? 'checked' : '' }}>
                                    Sun
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-4">
                                <label class="control-label">
                                    <input type="checkbox" name="exclude_admin" {{old('exclude_admin', $notif->exclude_admin) ? 'checked' : '' }}>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                        ...
                        <div class="form-group{{ $errors->has('schedule_remind_clock_in') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                ...
                                @if ($errors->has('schedule_remind_clock_in'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('schedule_remind_clock_in') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>

                        <div class="form-group{{ $errors->has('schedule_remind_clock_out') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                ...
                                @if ($errors->has('schedule_remind_clock_out'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('schedule_remind_clock_out') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
