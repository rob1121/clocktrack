...
class JobSummary extends ExcelExtract implements Downloadable
{
    /**
     * date from
     *
    ...
    public function download()
    {
        ...
        $filename = $this->setFilename('job summary');
     ...
     * @return void
     */
    protected function excelDataValidFormat($timesheet, $job)
    {
        $retVal = [
            'job' => $job,
        ];
     ...
     * @return void
     */
    protected function groupByJob(&$timesheets)
    {
